...
(templates["addfunds/alert"] = _.template(
    ...
    (templates["admin/payment_settings_file"] = _.template(
        "<div class=\"form-group\">\n    <label for=\"edit-payment-method-options-<%= data['code'] %>\" class=\"control-label\"><%= data['label'] %></label>\n    <input type=\"hidden\" name=\"EditPaymentMethodForm[files][<%= data['name'] %>]\" value=\"<%= data['file_name'] !== undefined ? data['file_name'] : data['name'] %>\">\n    <input type=\"file\" name=\"EditPaymentMethodForm[<%= data['name'] %>]\" accept=\"<%= data['accept'] !== undefined ? data['accept'] : '*' %>\">\n</div>"
    )),
    ...
    (customModule.layouts = {
        run: function (a) {
            $(document).on("click", ".alert .close", function (e) {
                ...
                $("#currencies-list #currencies-item").on(
                    "click",
                    function (e) {
                        e.preventDefault();
                        var t = $(e.target).data(),
                        ...
                        custom.ajax({
                            url: "/change-currency",
                            data: "currency=" + t.rateKey + "&_csrf=" + e,
                            method: "POST",
                            success: function (e) {
                                "success" == e.status &&
                ...
                $(function () {
                    function n(e) {
                        $("[data-filter-active-category]").html(e);
                    }
                    function o(e) {
                        var t = $("[data-filter-table-wrapper]");
                        t.length &&
                            (e
                                ? t.removeClass("hidden")
                                : t.each(function () {
                                      $(this).find(
                                          "[data-filter-table-category-id]"
                                      ).length ===
                                          $(this).find(".hidden").length &&
                        ...
                        $.extend($.expr[":"], {
                            containsi(e) {
                                var t = e.innerHTML.match(
                                        /data-filter-table-service-name=\"true\"[^>]*>(.*?)<\/td>/is
                                    ),
                                    a = e.innerHTML.match(
                                        /data-filter-table-service-id=\"([\d]+)\".*?/is
                                    ),
                                    e = $(e).data("filter-table-category-id"),
                                    e =
                                        r &&
                                        parseInt(e, 10) === parseInt(r, 10),
                                    t =
                                        t &&
                                        t[1] &&
                                        -1 !==
                            ...
                            o("clear"),
                            $(e + " [data-filter-table-category-id]")
                                .not(`:containsi('${n.toLowerCase()}')`)
                                .each(function () {
                                    $(this).addClass("hidden");
                                }),
                            $(
                                `${e} [data-filter-table-category-id]:containsi('${n.toLowerCase()}')`
                            ).each(function (e) {
                                $(this).removeClass("hidden");
                            }),
                            n ||
                                (null === r &&
                                    $("[data-filter-table-category-id]").each(
                                        function (e) {
                                            $(this).removeClass("hidden");
                                        }
                                    )),
                    ...
                    $("[data-filter-category-id]").on("click", function (e) {
                        e.preventDefault();
                        var t = $(this).data("filter-category-id"),
                            a = $(this).data("filter-category-name"),
                            e = $("[data-search-service]").data().searchService;
                        void 0 !== t &&
                            ("All" === t
                                ? ((r = null),
                                  n(""),
                                ...
                                : ($(
                                  ...
                                  $(
                                      `[data-filter-table-category-id="${t}"]`
                                  ).removeClass("hidden"),
                                  (r = "" + t),
                                  n(a),
                                  o("clear"),
                        ...
                        $("[data-search-service]").keyup(function () {
                            var e = $(this).data("search-service"),
                                t = e + " tr",
                                a = $(this).val().toLowerCase();
                            1500 < $(t).length || i((l = a), e);
                        }),
                        $(document).on("keypress", function (e) {
                            var t;
                            13 !== e.which ||
                                ((t = $("[data-search-service]")).is(
                                    ":focus"
                                ) &&
                                    ((e = t.val()),
                                    (t = t.data("search-service")),
                                    i(e, t)));
                        }),
                        $("[data-filter-serch-btn]").on("click", function () {
                            var e = $("[data-search-service]"),
                                t = e.val(),
                                e = e.data("search-service");
                            i(t, e);
                        });
                });
        },
    ...
    (customModule.siteAddfunds = {
        ...
        run: function (e) {
            ...
            t.updateAmountLabel(),
                $(document).on("change", "#method", function (e) {
                    ...
                    t.updateFields(e),
                        t.updateAmount(e),
                        t.updateAmountCurrency(e);
                }),
                void 0 !== e.options &&
                    (void 0 !== e.options.stripe &&
                        t.initStripe(e.options.stripe),
                    void 0 !== e.options.bluesnap &&
                        t.initBlueSnap(e.options.bluesnap),
                    void 0 !== e.options.razorpay &&
                        t.initRazorpay(e.options.razorpay),
                    ...
                    void 0 !== e.options.midtrans &&
                        t.initMidtrans(e.options.midtrans),
                    void 0 !== e.options.paywithpaytm &&
                        t.initPaytm(e.options.paywithpaytm),
                    void 0 !== e.options.paytmimap &&
                        t.initPaytm(e.options.paytmimap),
                    void 0 !== e.options.klikbca &&
                        t.initKlikbca(e.options.klikbca),
                    ...
                    void 0 !== e.options.buypayer &&
                        t.initBuypayer(e.options.buypayer),
                    ...
                    void 0 !== e.options.squareup &&
                        t.initSquareup(e.options.squareup),
                    ...
                    void 0 !== e.options.manual_77 &&
                        t.initManual(e.options.manual_77),
                    void 0 !== e.options.manual_243 &&
                        t.initManual(e.options.manual_243),
                    void 0 !== e.options.manual_244 &&
                        t.initManual(e.options.manual_244),
                    void 0 !== e.options.manual_245 &&
                        t.initManual(e.options.manual_245),
                    void 0 !== e.options.manual_246 &&
                        t.initManual(e.options.manual_246),
                    ...
                    void 0 !== e.options.pay2pay &&
                        t.initCard(e.options.pay2pay),
                    void 0 !== e.options.phonepe &&
                        t.initPhonePe(e.options.phonepe),
                    ...
                    void 0 !== e.options.payiyo &&
                        t.initQrModal(e.options.payiyo),
                    ...
                    void 0 !== e.options.paghiper &&
                        t.initPaghiper(e.options.paghiper),
                    void 0 !== e.options.sumup && t.initSumup(e.options.sumup),
                    void 0 !== e.options.stcpay &&
                        t.initStcPay(e.options.stcpay),
                    void 0 !== e.options.geidea &&
                        t.initGeidea(e.options.geidea),
                    void 0 !== e.options.paymobkiosk &&
                        t.initPaymobKiosk(e.options.paymobkiosk),
                    void 0 !== e.options.paysky &&
                        t.initPaysky(e.options.paysky)),
        ...
        updateAmountLabel: function () {
            ...
            a.length ||
                ((e = $('label[for="amount"]', $("#amount").parents("form")))
                    .length &&
                    ((t = $("<span/>", {
                        id: "amount_label",
                    }).text(e.text())),
        ...
        initRazorpay: function (o) {
            ...
            $("button", i.fieldsContainer).on("click", function (e) {
                ...
                (n.handler = function (e) {
                    ...
                    ).value = e.razorpay_payment_id),
                        (document.getElementById(
                            "field-razorpay_signature"
                        ).value = e.razorpay_signature),
                        (document.getElementById(
            ...
            $(document).on("change", "#method", function (e) {
                ...
                l.html(s),
                    ...
                    t == a.type &&
                        ...
                        n.fieldOptions[t].amount &&
                            l.html(n.fieldOptions[t].amount.label),
                        n.fieldOptions[t].submit &&
                            d.html(n.fieldOptions[t].submit.label),
                        r.after(e.join("\r\n")));
            });
        },
        ...
        initPaysky: function (l) {
            var d = this,
                s = l.configure,
                c = $("#method"),
                e = $("button[type=submit]", d.fieldsContainer),
                t = $("<button />", s).hide();
            e.after(t),
                e.on("click", function (e) {
                    if (c.val() == l.type) {
                        ...
                        return (
                            $.ajax({
                                ...
                                success: function (e) {
                                    "success" == e.status &&
                                        ((a = e.data.secureHash),
                                        (n = e.data.merchantReference),
                                        (o = e.data.transactionDate),
                                        (i = e.data.processingUrl),
                                        (r = e.data.amount));
                                },
                            }),
            ...
            o.after(i),
                o.on("click", function (e) {
                    if (n.val() == t.type && 0 < +$.trim(a.val()))
                        return (
                            e.stopImmediatePropagation(), i.trigger("click"), !1
                        );
                });
        },
        responseAuthorizeHandler: function (e) {
            if ("Error" === e.messages.resultCode)
                for (var t = 0; t < e.messages.message.length; )
                    alert(
                        e.messages.message[t].code +
                            ": " +
                            e.messages.message[t].text
                    ),
                        (t += 1);
            else
        ...
        initOmise: function (n) {
            ...
            $(document).on("change", "#method", function (e) {
                $(this).val() == n.type &&
                    (((t = $.extend({}, !0, n.config)).submitFormTarget =
                        "#form_id"),
    ...
    (customModule.siteHistory = {
        run: function (e) {
            $("#setRefill").on("show.bs.modal", function (e) {
                ...
                var t = $(this),
                    t = $("form", t);
                $('input[name="id"]', t).val($(e.relatedTarget).data("href")),
    ...
    (customModule.siteOrder = {
        ...
        run: function (e) {
            ...
            (n.services = $.extend({}, !0, e.services)),
                ...
                n.updateFields(e, !1, n.services[t].link_type),
                n.updateCharge(),
                n.updateDescription(),
                n.updateAverageTime(),
                n.updateQuantityHelpBlock(),
        ...
        getMaxQuantityValue: function () {
            var e = this.getServicePriceByOrigin(!1);
            return e <= 0
                ? Number.MAX_SAFE_INTEGER
                : parseInt(Number.MAX_SAFE_INTEGER - 1 / e);
        },
        preparePrice: function (e, t) {
            var a = this.format,
                n = a.min;
            e = this.toFixed(e);
            var o = (e = $.trim(e.toString().replace(",", "."))).split(".");
            void 0 !== o[1] &&
                ((o[1] = o[1].replace(/0+$/g, "")),
                o[1].length > n &&
                    (n = a.max < o[1].length ? a.max : o[1].length)),
                (e = (e =
                    1e3 <= (e = (e = parseFloat(e)).toFixed(n))
                        ? e.replace(
                              /(\d)(?=(\d\d\d)+([^\d]|$))/g,
                              "$1" + a.thousands
                          )
                        : e).replace(/\.(\d+)$/g, a.delimiter + "$1"));
            a = this.currencyOptions;
            return (e = (t ? a.original_template : a.template).replace(
                "{{value}}",
                e
            ));
        },
        getServicePriceByOrigin: function (e) {
            var t = $("#orderform-service"),
                t = this.services[t.val()];
            if (!t) return 0;
            t = e ? t.orig_price : t.price;
            return parseFloat(t);
        },
        ...
        updateCharge: function () {
            var e = this,
                t = $("#charge"),
                a = t.parent(".form-group"),
                n = $("#field-orderform-fields-quantity"),
                o = $("#orderform-service"),
                i = e.getMaxQuantityValue(),
                r = e.currencyOptions.converted;
            if (
                (a.show(),
                r && $(t).tooltip(),
                t.val(e.preparePrice(0)),
                e.services[o.val()])
            ) {
                var l = e.getServicePriceByOrigin(!1),
                    d = e.getServicePriceByOrigin(!0),
                    o = +e.getCurrentServiceType();
                if (10 == o || 14 == o || 16 == o)
                    return (
                        t.val(e.preparePrice(l)),
                        void (
                            r &&
                            $(t).attr(
                                "data-original-title",
                    ...
                    return n &&
                        ...
                        ? ((n = parseInt(n)),
                          isNaN(n)
                              ? (t.val(""),
                                void (
                                    r && $(t).attr("data-original-title", "")
                                ))
                              : ((l *= n = i < n ? i : n),
                                (d = (d * n) / 1e3),
                                t.val(e.preparePrice((l /= 1e3))),
                                void (
                                    r &&
                                    $(t).attr(
                                        "data-original-title",
                        ...
                        : (t.val(""),
                          void (r && $(t).attr("data-original-title", "")));
                }
                a.hide();
            }
        },
        toFixed: function (e) {
            ...
            return (
                Math.abs(e) < 1
                    ? (t = parseInt(e.toString().split("e-")[1])) &&
                      ((e *= Math.pow(10, t - 1)),
                      (e =
                          "0." +
                          new Array(t).join("0") +
                          e.toString().substring(2)))
                    : 20 < (t = parseInt(e.toString().split("+")[1])) &&
                      ((t -= 20),
                      (e /= Math.pow(10, t)),
            ...
            if (
                ...
                $.each(r.fields[e], function (e, t) {
                    ...
                    void 0 !== t &&
                        t &&
                        (a.val(""),
                        $('.fields input[type="checkbox"]').prop(
                            "checked",
                            !1
                        )),
                    r.updateCharge(),
